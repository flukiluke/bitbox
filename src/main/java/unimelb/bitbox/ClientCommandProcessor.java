...
/**
 * Command logic for both the client and the peer's handling of clients.
 *
...
public class ClientCommandProcessor {
    ...
    /**
     * Main entry point. Parses a message from the client protocol acts upon it.
     *
     * @param msgIn The message
     * @return A (possibly empty) list of replies to be sent
     * @throws BadMessageException If the message is malformed
     */
